...
def result(request):
    ...
    b = insurance(age=request.GET['age'],sex=request.GET['sex'],bmi=request.GET['bmi'],childrens=request.GET['children'],smoker=request.GET['smoker'],region=request.GET['region'],expenses=answer)
    b.save()
